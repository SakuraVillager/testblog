...
|其他|支持`Git`分支可视化，有利于分支管理|便于编辑markdown文章，附件自动管理等|

可以说是各有利弊吧。如果你本来就有使用这些软件，我的建议是不要倒腾新软件，直接使用你原来使用的那个即可。如果你没有使用过这两款软件中的任意一款，那我推荐你尝试一下`Obsidian`。
...
:::note
在使用插件前，请先按照常规方法配置git并完成首次初始化、提交与推送。
:::
